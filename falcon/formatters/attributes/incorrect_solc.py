...
def custom_format(falcon, result):
...
def _patch(falcon, result, in_file, solc_version, modify_loc_start, modify_loc_end):
    in_file_str = falcon.source_code[in_file].encode("utf8")
