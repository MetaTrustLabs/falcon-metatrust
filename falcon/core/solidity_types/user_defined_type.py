...
class UserDefinedType(Type):
    ...
    def storage_size(self) -> Tuple[int, bool]:
        ...
        if isinstance(self._type, Structure):
            # todo there's some duplicate logic here and falcon_core, can we refactor this?
            slot = 0
            offset = 0
        ...
        raise FalconException(to_log)

    def __str__(self):
        from falcon.core.declarations.structure_contract import StructureContract
        from falcon.core.declarations.enum_contract import EnumContract
