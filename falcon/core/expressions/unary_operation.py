...
class UnaryOperationType(Enum):
    ...
    def get_type(operation_type, isprefix):
        ...
        raise FalconCoreError(f"get_type: Unknown operation type {operation_type}")
    ...
    def __str__(self):
        ...
        raise FalconCoreError(f"str: Unknown operation type {self}")
    ...
    def is_prefix(operation_type):
        ...
        raise FalconCoreError(f"is_prefix: Unknown operation type {operation_type}")
