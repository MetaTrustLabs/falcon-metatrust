...
class FalconCompilationUnit(Context):
    def __init__(self, core: "FalconCore", crytic_compilation_unit: CompilationUnit):
        super().__init__()
        ...
        self.counter_falconir_tuple = 0
        self.counter_falconir_temporary = 0
        self.counter_falconir_reference = 0

        self.scopes: Dict[Filename, FileScope] = {}

    @property
    def core(self) -> "FalconCore":
        return self._core
