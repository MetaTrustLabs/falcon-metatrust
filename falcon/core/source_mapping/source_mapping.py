...
class Source:
    def __init__(self) -> None:
        ...
        self.end: int = 0
        self.compilation_unit: Optional["FalconCompilationUnit"] = None
...
def _compute_line(
    compilation_unit: "FalconCompilationUnit", filename: Filename, start: int, length: int
...
def _convert_source_mapping(
    offset: str, compilation_unit: "FalconCompilationUnit"
...
class SourceMapping(Context, metaclass=ABCMeta):
    ...
    def set_offset(self, offset: Union["Source", str], compilation_unit: "FalconCompilationUnit"):
    ...
    def add_reference_from_raw_source(
        self, offset: str, compilation_unit: "FalconCompilationUnit"
    ):
