...
from falcon.analyses.evm import (
    generate_source_to_evm_ins_mapping,
    load_evm_cfg_builder,
)
from falcon.utils.colors import blue, green, magenta, red


def _extract_evm_info(falcon):
    """
