...
from falcon.tools.similarity.cache import save_cache
from falcon.tools.similarity.encode import encode_contract, load_contracts
from falcon.tools.similarity.model import train_unsupervised
