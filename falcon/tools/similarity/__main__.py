...
from falcon.tools.similarity.info import info
from falcon.tools.similarity.test import test
from falcon.tools.similarity.train import train
from falcon.tools.similarity.plot import plot
