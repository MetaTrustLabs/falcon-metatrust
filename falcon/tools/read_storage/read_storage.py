...
try:
    ...
    print("ERROR: in order to use falcon-read-storage, you need to install web3")
...
from falcon.core.solidity_types import ArrayType, ElementaryType, UserDefinedType, MappingType
from falcon.core.declarations import Contract, Structure
...
logging.basicConfig()
logger = logging.getLogger("Falcon-read-storage")
...
class FalconReadStorageException(Exception):
    pass


# pylint: disable=too-many-instance-attributes
class FalconReadStorage:
    ...
    def _find_array_slot(
        ...
        if isinstance(
            ...
            if isinstance(target_variable_type_type, UserDefinedType) and isinstance(
                ...
                info_tmp, type_to, slot, size, offset = FalconReadStorage._find_struct_var_slot(
