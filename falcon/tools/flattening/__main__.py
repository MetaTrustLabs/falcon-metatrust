...
from falcon.tools.flattening.flattening import (
    Flattening,
    Strategy,
    STRATEGIES_NAMES,
    DEFAULT_EXPORT_PATH,
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Contracts flattening ",
        usage="falcon-flat filename",
    )
...
def main():
    ...
    for compilation_unit in falcon.compilation_units:
