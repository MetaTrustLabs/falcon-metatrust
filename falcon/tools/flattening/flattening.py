...
from falcon.core.declarations import SolidityFunction, EnumContract, StructureContract
...
from falcon.core.solidity_types import MappingType, ArrayType
...
from falcon.ir.operations import NewContract, TypeConversion, SolidityCall, InternalCall
from falcon.tools.flattening.export.export import (
    Export,
    export_as_json,
    save_to_zip,
    save_to_disk,
...
logger = logging.getLogger("Falcon-flattening")
...
class Flattening:
    ...
    def __init__(
        ...
        self._compilation_unit: FalconCompilationUnit = compilation_unit
            ...
            for f in contract.functions_declared:
                ...
                if f.visibility == "external":
                    ...
                    if regex:
                        ...
                        raise FalconException(f"External keyword not found {f.name} {attributes}")
