...
from falcon.ir.operations import Index, OperationWithLValue, InternalCall, Operation
...
def compute_dependency(compilation_unit: "FalconCompilationUnit") -> None:
...
def compute_dependency_contract(
    contract: Contract, compilation_unit: "FalconCompilationUnit"
) -> None:
