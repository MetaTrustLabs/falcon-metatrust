...
from falcon.core.solidity_types import ArrayType, MappingType, ElementaryType, UserDefinedType
...
def _convert_type_for_solidity_signature_to_string(types: Union[Type, List[Type]]) -> str:
    if isinstance(types, Type):
        ...
        # But the falcon type system is not straightforward to manipulate here
...
def convert_type_for_solidity_signature(t: Type) -> Union[Type, List[Type]]:
    ...
    from falcon.core.declarations import Contract, Enum, Structure
