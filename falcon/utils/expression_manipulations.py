...
from falcon.core.expressions import UnaryOperation
...
from falcon.core.expressions.conditional_expression import ConditionalExpression
...
from falcon.core.expressions.new_array import NewArray
from falcon.core.expressions.new_contract import NewContract
...
class SplitTernaryExpression:
    ...
    def copy_expression(
        ...
        if isinstance(expression, ConditionalExpression):
            raise FalconException("Nested ternary operator not handled")
