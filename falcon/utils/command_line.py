...
from falcon.detectors.abstract_detector import classification_txt
from falcon.utils.colors import yellow, red
...
def read_config_file(args):
    ...
    if args.config_file is None:
        ...
        if os.path.exists("falcon.config.json"):
            # The default file exists, use it
            args.config_file = "falcon.config.json"
        else:
            return
