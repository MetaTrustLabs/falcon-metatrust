...
from falcon.utils.function_dependency_tree import build_dependency_tree
...
class TransactionOrderDependencyLow(AbstractDetector):  # pylint: disable=too-few-public-methods
    ...
    ARGUMENT = "transaction-order-dependency-low"  # falcon will launch the detector with falcon.py --mydetector
