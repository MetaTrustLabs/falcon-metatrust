...
from falcon.utils.function_dependency_tree import build_dependency_tree_token_flow_or_money_flow
...
class TransactionOrderDependencyHigh(AbstractDetector):  # pylint: disable=too-few-public-methods
    ...
    ARGUMENT = "transaction-order-dependency-high"  # falcon will launch the detector with falcon.py --mydetector
