...
from falcon.utils.function_permission_check import function_can_only_initialized_once, function_has_caller_check
from falcon.utils.function_dependency_tree import build_dependency_tree_token_flow_or_money_flow, build_dependency_tree
...
class TransactionOrderDependencyMedium(AbstractDetector):  # pylint: disable=too-few-public-methods
    ...
    Documentation
    """
    ARGUMENT = "transaction-order-dependency-medium"  # falcon will launch the detector with falcon.py --mydetector
