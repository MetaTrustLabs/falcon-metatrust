...
from falcon.formatters.naming_convention.naming_convention import custom_format


class NamingConvention(AbstractDetector):
    """
    clone from falcon/detectors/naming_convention/naming_convention.py
    """
        ...
        for contract in self.contracts:
            ...
            for func in contract.functions_declared:
                ...
                if not self.is_mixed_case(func.name):
                    ...
                    # filter DOMAIN_SEPARATOR/PERMIT_TYPEHASH/MINIMUM_LIQUIDITY/WETH
                    if func.name in ['DOMAIN_SEPARATOR', 'PERMIT_TYPEHASH', 'MINIMUM_LIQUIDITY', 'WETH']:
                        continue
                ...
                for argument in func.parameters:
                    ...
                    if argument in func.variables_read_or_written:
                        correct_naming = self.is_mixed_case(argument.name) or \
                                         self.is_mixed_case_with_underscore(argument.name)
                    else:
