...
def _find_missing_inheritance(compilation_unit: FalconCompilationUnit):
    """
...
"""
    ...
    def _detect(self):  # pylint: disable=too-many-locals,too-many-branches
        ...
        all_contracts_name = [c.name for c in all_contracts if not c.is_interface]
        ...
        incorrectly_constructed = [
            ...
            if contract.is_incorrectly_constructed and not contract.is_interface
        ]
        ...
        for b in most_base_with_missing_inheritance:
            ...
            if b.inheritance:
                info += ["\t- Falcon could not determine which contract has a duplicate name:\n"]
