...
from falcon.core.declarations import Modifier, Event, EnumContract, StructureContract, Function
...
from falcon.core.solidity_types import ElementaryType, TypeAliasContract
...
from falcon.solc_parsing.declarations.event import EventSolc
from falcon.solc_parsing.declarations.function import FunctionSolc
from falcon.solc_parsing.declarations.modifier import ModifierSolc
from falcon.solc_parsing.declarations.structure_contract import StructureContractSolc
from falcon.solc_parsing.exceptions import ParsingError, VariableNotFound
from falcon.solc_parsing.solidity_types.type_parsing import parse_type
from falcon.solc_parsing.variables.state_variable import StateVariableSolc
...
class ContractSolc(CallerContextExpression):
    def __init__(self, falcon_parser: "FalconCompilationUnitSolc", contract: Contract, data):
    ...
    def _parse_custom_error(self, custom_error: Dict):
        ...
        ce_parser = CustomErrorSolc(ce, custom_error, self._falcon_parser)
    ...
    def _parse_modifier(self, modifier_data: Dict):
        ...
        modif_parser = ModifierSolc(modif, modifier_data, self, self.falcon_parser)
        ...
        self._falcon_parser.add_function_or_modifier_parser(modif_parser)
    ...
    def _parse_function(self, function_data: Dict):
        ...
        func_parser = FunctionSolc(func, function_data, self, self._falcon_parser)
        ...
        self._falcon_parser.add_function_or_modifier_parser(func_parser)
    ...
    def _analyze_params_element(  # pylint: disable=too-many-arguments
        ...
        elem_parser = Cls_parser(
            elem, element_parser.function_not_parsed, self, self.falcon_parser
        )
        if (
        ...
        self._falcon_parser.add_function_or_modifier_parser(elem_parser)
    ...
    def _analyze_params_elements(  # pylint: disable=too-many-arguments,too-many-locals
        ...
        try:
            for father in self._contract.inheritance:
                father_parser = self._falcon_parser.underlying_contract_to_parser[father]
