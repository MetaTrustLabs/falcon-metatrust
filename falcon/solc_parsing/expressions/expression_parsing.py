...
from falcon.core.expressions.assignment_operation import (
    AssignmentOperation,
    AssignmentOperationType,
)
from falcon.core.expressions.binary_operation import (
    BinaryOperation,
    BinaryOperationType,
)
...
from falcon.solc_parsing.expressions.find_variable import find_variable
from falcon.solc_parsing.solidity_types.type_parsing import UnknownType, parse_type
