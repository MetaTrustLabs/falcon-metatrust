...
/**
    Note that: This example has a protection against signature replay attacks.
    Please see lines 36, 37, and 44.
*/
...
contract swc121_example1{
  ...
  function transfer(
    ...
    returns (bool)
    {
        bytes32 txid = keccak256(abi.encodePacked(getTransferHash(_to, _value, _gasPrice, _nonce), _offset));
