contract Bug{
  ...
  modifier onlyClaimableAdmin {
    require(msg.sender == claimable_owner);
    _;
  }
  ...
  function correct_change0(address newOwner) onlyAdmin external {
    require(newOwner != address(0));
    claimable_owner = newOwner; // for owner to claim
  }
  
  function correct_claim0() onlyClaimableAdmin external {
    owner = claimable_owner;
