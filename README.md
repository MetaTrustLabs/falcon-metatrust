...
| Detector Name | Detector File | Release Date                                                               |                                                                                                                                                                                             |
|------------------------------------|:-----------------------------------------------------------------------------|:------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Arbitrary send erc20 Basic Library | -  | 1 weeks later  | We have optimized Arbitrary send erc20 to reduce false positives                                                                                                                            |
| Centralized                        | -       |       1 weeks later             | We believe that centralized risk is one of the risks that should not be ignored, so we have implemented multiple centralized risk vulnerability detection rules with different risk levels. |
| bad_prng                           | - |  1 weeks later  | We believe that random number vulnerabilities only occur in functions with certain specific functions, so we simply filter the functions                                                                                                                                            |
| Transfer Inside a Loop             | - | 1 weeks later | Transfers in the loop can easily cause DOS attacks                                                                                                                                          |
| DeFi Related Detectors             | -       |       1 weeks later                    | We implemented a simple price manipulation detector to detect whether there is suspicious price manipulation through taint analysis, and divided it into multiple risk levels.              |
| ERC                                | -   |     1 weeks later                               | We have implemented detectors for multiple ERC standards                                                                                                                                    |
| Transaction Order Dependency       | -       |   1 weeks later                            | We implemented a detector for the Transaction Order Dependency vulnerability and divided it into multiple risk levels.                                                                      |
