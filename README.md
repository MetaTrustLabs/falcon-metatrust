...
|------------------------------------|:-----------------------------------------------------------------------------|:------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Arbitrary send erc20 Basic Library | -  | 1 week later  | We have optimized Arbitrary send erc20 to reduce false positives                                                                                                                            |
| Centralized                        | -       |       1 week later             | We believe that centralized risk is one of the risks that should not be ignored, so we have implemented multiple centralized risk vulnerability detection rules with different risk levels. |
| bad_prng                           | - |  1 week later  | We believe that random number vulnerabilities only occur in functions with certain specific functions, so we simply filter the functions                                                                                                                                            |
| Transfer Inside a Loop             | - | 1 week later | Transfers in the loop can easily cause DOS attacks                                                                                                                                          |
